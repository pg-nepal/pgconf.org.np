...
More detail: visit official website [1]
...
and process the payment via the following link[2]-
[2]: https://pgconf.org.np/registered/{slug}

Tickets are sold on a first-come, first-served basis, so payments
must be made promptly.

Note for International participants: we only support wire transfer.
For the details contact us via email (info@pgconf.org.np).
